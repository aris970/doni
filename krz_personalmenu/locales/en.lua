Locales['en'] = {
	...
	-- Main Menu
	['mainmenu_subtitle'] = ' PERSONAL MENU',
	...
	['loadout_drop_button'] = 'X',

	-- Wallet Menu
	['wallet_title'] = 'Licenses',
	['wallet_option_give'] = 'Give',
	['wallet_job_button'] = '~p~%s',
	['wallet_job2_button'] = 'Organization:%s -%s',
	['wallet_money_button'] = 'Cash: ~g~$%s',
	['wallet_blackmoney_button'] = 'Dirty money: ~r~$%s',
	['wallet_show_idcard_button'] = '~y~Give ID',
	...
	['vehicle_title'] = 'Vehicle Management',
        ['omerb'] = '~b~__________________________',
	...
	['admin_title'] = '~w~___________________',
